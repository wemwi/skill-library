...
`restock.md` = Inhalt aus `selectedleafs-pos-restock` v1.8.0, 1:1 migriert (byte-verifiziert) + Restock-Post-Templates eingezogen. `telegram.md` = generisches Handwerk aus `selectedleafs-telegram` (v13), domänenspezifische Templates herausgezogen. Die beiden Quell-Skills werden nach Umstellung der Agenten deprecated.
