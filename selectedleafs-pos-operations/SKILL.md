...
| *(geplant)* Vertriebler onboarden/verwalten (`registry.md` §4, `POS-PARTNER`/`POS-SHEET`-Marker) | `references/salesperson.md` — *geplant, nicht implementiert (fail-closed bei Load)* |
