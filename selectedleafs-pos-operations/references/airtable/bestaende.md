...
- **`IST`** (Formel) — laufender Bestand: `⚙ IST (Prüfstand)` **+** `⚙ Geliefert seit Prüfung`.
...
- Rollups: `⚙ Geliefert` · `⚙ Verkauft` · `⚙ IST` · `⚙ Geliefert seit Prüfung` · `⚙ Warenkosten` · `Letzte Prüfung`.
...
| ⚙ IST | rollup (← Prüfstempel) | `fldfho1EkQTGY6kVG` |
